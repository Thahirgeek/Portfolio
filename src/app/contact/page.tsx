...
const Contact = () => {
  ...
  const animatedText = useMemo(
    () => (
      <motion.div initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 1}} className="font-[panchangbold] md:text-[8vmax] sm:text-5xl max-sm:text-6xl leading-none border-t border-b border-zinc-600 max-sm:mt-10 pt-3 pb-3">
          ...
          {!isActive ? (
            ...
            >
              <div className="font-[clash] w-fit">
                ...
                <h2 className="text-center lg:text-4xl md:text-2xl sm:text-xl max-sm:text-2xl mt-20 tracking-wider border-b rounded-sm">Find me on my socials</h2>
